...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">Laboratory Reagent Requests</h3>
            <a href="{{ route('laboratory.reagent.create') }}" class="btn btn-primary">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('laboratory.reagent.show', $record->request_id) }}" 
