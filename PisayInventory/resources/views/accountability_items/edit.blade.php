...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Accountability Item</h3>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            @endif
            <form method="POST" action="{{ route('accountability-items.update', $item->item_id) }}">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="issued_condition" class="form-control" value="{{ old('issued_condition', $item->issued_condition) }}">
                </div>
                <div class="mb-3">
                    <label>Returned Condition</label>
                    <input type="text" name="returned_condition" class="form-control" value="{{ old('returned_condition', $item->returned_condition) }}">
                </div>
