...
/* Update font sizes to be smaller */
.nav-link {
    font-size: 0.8rem;  /* Even smaller font size for nav links */
    display: flex;
    align-items: center;
...
.dropdown-item {
    font-size: 0.8rem;  /* Even smaller font size for dropdown items */
    color: white !important;
...
.dropdown-item i {
    font-size: 0.85rem;  /* Smaller icon size in dropdowns */
    width: 18px;  /* Reduced width */
    margin-right: 8px;  /* Reduced margin */
    text-align: center;
}
...
.sidebar-title {
    font-size: 0.8rem;  /* Smaller header title */
    white-space: nowrap;
    letter-spacing: -0.5px;
...
/* Update logo size */
.sidebar-logo {
    width: 22px;  /* Even smaller logo */
    height: 22px;
    object-fit: contain;
    margin-right: 2px !important;
}

/* Make chevron icon smaller */
.nav-link .bi-chevron-down {
    font-size: 8px;  /* Smaller chevron */
}
</style>
