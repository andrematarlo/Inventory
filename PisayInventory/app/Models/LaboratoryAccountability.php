...
class LaboratoryAccountability extends Model
{
    use SoftDeletes;

    protected $table = 'laboratory_accountability';
    ...
    {
        return $this->hasMany(LaboratoryAccountabilityItem::class);
    }
} 